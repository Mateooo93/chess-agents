---
name: regex-chess
description: Implement chess move generators using only regular expressions. Use when transforming board state (FEN notation) through pattern matching and substitution rather than traditional programming constructs.
---
